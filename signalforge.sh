...
# /mnt/e/matlab/bin/matlab.exe -nodisplay -nosplash -nodesktop -r "cd('./matlab'); main(7, '"$mode"', '"$output_dir"'); exit;"
...
if [ $return_code -ne 0 ]; then
    echo -e "${RED}Something went wrong. Code: $return_code.${NC}"
else
...
# Print total
echo -e "${BLUE}Execution completed in ${execution_time} seconds.${NC}"
